...
class BaseValidation:
    ...
    def negate(self) -> BaseValidation: ...
...
class does_not(BaseValidation):
    ...
    def then(self, *rules: Validations) -> does_not: ...
...
class when(BaseValidation):
    ...
    def handle(self, dictionary: dict[str, Any]) -> None: ...
    then_rules: Validations
    def then(self, *rules: Validations) -> when: ...
...
class Validator:
    ...
    def extend(self, key: str | dict[str, Any], obj: Optional[Any] = ...) -> Validator: ...
