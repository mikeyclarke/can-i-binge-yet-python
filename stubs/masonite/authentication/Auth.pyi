...
Guard_T = TypeVar('Guard_T', bound=Guard)
...
class Guard(Protocol):
    ...
    def once(self) -> Guard_T: ...
    def logout(self) -> Guard_T: ...
...
class Auth:
    ...
    def user(self) -> Authenticates | Literal[False] | None: ...
    def register(self, dictionary: dict[str, Any]) -> Authenticates | Literal[False] | None: ...
    def set_user(self, user: Authenticates | Literal[False] | None) -> T: ...
