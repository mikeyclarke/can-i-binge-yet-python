...
class Route:
    ...
    @classmethod
    def default(self, url: str, controller: Controller, **options: Any) -> T: ...
    @classmethod
    ...
    @classmethod
    def compile(self, key: str, to: str = ...) -> T: ...
    @classmethod
    def set_controller_locations(self, *controllers_locations: str) -> T: ...
    @classmethod
    def add_controller_locations(self, *controllers_locations: str) -> T: ...
