...
class HTTPRoute:
    ...
    def middleware(self, *args: Any) -> HTTPRoute: ...
    def prepend_middleware(self, *args: Any) -> HTTPRoute: ...
    def get_middlewares(self) -> Middlewares: ...
    def set_middleware(self, middleware: Middlewares) -> HTTPRoute: ...
    def exclude_middleware(self, *args: Middlewares) -> HTTPRoute: ...
    def compile_route_to_regex(self) -> str: ...
    def extract_parameters(self, path: str) -> dict[str, Any]: ...
    def casts(self, _casts_map: dict[str, Any] = ...) -> HTTPRoute: ...
